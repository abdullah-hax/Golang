...
func createProduct(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == "OPTIONS" { // option successful holei post req krbe , post req i krbe karon FE e leka ache  "const response = await api.get('/create-products', productData);"
		w.WriteHeader(201)
		return
	}
